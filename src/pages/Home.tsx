...
/* ─── Reveal wrapper: children slide up + fade in ─── */
const Reveal = ({
  children,
  delay = 0,
  className = "",
...
/* ─── Section label ─── */
function SectionLabel({ ar, en, light = false }: { ar: string; en: string; light?: boolean }) {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <section className="relative h-[100dvh] bg-charcoal flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <motion.div
            ...
            className="absolute -top-[40%] -end-[15%] w-[700px] h-[700px] rounded-full border border-gold/20"
          />
          <motion.div
            animate={{ scale: [1, 1.08, 1], opacity: [0.2, 0.5, 0.2] }}
            transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 2.5 }}
            className="absolute -top-[25%] -end-[5%] w-[480px] h-[480px] rounded-full border border-gold/12"
          />
          <motion.div
            animate={{ scale: [1, 1.04, 1], opacity: [0.1, 0.3, 0.1] }}
            transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 1 }}
            className="absolute -top-[55%] -end-[25%] w-[900px] h-[900px] rounded-full border border-gold/8"
          />
          {/* diagonal gradient */}
        ...
        <div className="relative z-10 text-center max-w-5xl px-6 flex flex-col items-center">
          ...
          <motion.div
            ...
            className="w-[1px] h-12 bg-gradient-to-b from-transparent via-gold to-transparent mx-auto mb-7"
          />

          {/* Name */}
          <motion.p
            initial={{ y: 14, opacity: 0.3 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.45, ease: [0.16, 1, 0.3, 1] }}
            className="font-sans font-extralight text-xs md:text-sm tracking-[0.45em] text-gold-light uppercase mb-5"
          >
            <span className="ar">خالد دياب</span>
            <span className="en">Khaled Diab</span>
          </motion.p>

          {/* Main title */}
          <motion.h1
            initial={{ y: 22, opacity: 0.2 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 1, delay: 0.6, ease: [0.16, 1, 0.3, 1] }}
            className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-cream-light leading-[1.1] -tracking-[0.02em] mb-3"
          >
            Future Design
          </motion.h1>
          <motion.h1
            ...
            className="font-serif italic text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-gold leading-[1.1] -tracking-[0.02em] mb-10"
          >
            Decore
          </motion.h1>
          ...
          {/* Subtitle */}
          <motion.p
            initial={{ y: 16, opacity: 0.25 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: 0.9, delay: 0.9, ease: [0.16, 1, 0.3, 1] }}
            className="font-sans font-light text-xs sm:text-sm md:text-base text-cream/55 tracking-[0.2em] uppercase mb-12 leading-loose"
          >
          ...
          >
            <a
              ...
              className="group relative inline-flex items-center gap-3 px-10 py-4 border border-gold/40 text-gold-light font-sans text-xs tracking-[0.3em] uppercase overflow-hidden transition-colors duration-300 hover:text-charcoal"
            >
              ...
              <span className="relative z-10">
                <span className="ar">استكشف خدماتنا</span>
        ...
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-28 items-center">
          ...
          <Reveal direction="left">
            ...
            <h2 className="font-serif text-4xl lg:text-5xl xl:text-6xl text-charcoal leading-[1.15] mb-8">
              <span className="ar">
                نحوّل <em className="not-italic text-gold-dark">المساحات</em>
                <br />إلى تحف فنية
              </span>
              <span className="en">
                We Transform <em className="italic text-gold-dark">Spaces</em>
                <br />into Masterpieces
              </span>
            </h2>
            <div className="space-y-5 text-text-muted font-light text-base md:text-lg leading-[2]">
              <p className="ar">
                في فيوتشر ديزاين ديكور، نؤمن بأن كل مساحة تروي قصة. بقيادة المصمم خالد دياب، نجمع بين الفخامة والوظيفة لنبتكر تصاميم داخلية تعكس شخصية عملائنا وترتقي بأسلوب حياتهم.
              </p>
              <p className="ar">
                نقدم حلولاً متكاملة من التصميم على الورق حتى التسليم النهائي، مع اهتمام استثنائي بأدق التفاصيل وأعلى معايير الجودة.
              </p>
              <p className="en">
                At Future Design Decore, we believe every space tells a story. Led by designer Khaled Diab, we combine luxury with functionality to create interior designs that reflect our clients' personalities.
              </p>
              <p className="en">
                We provide end-to-end solutions from initial concept to final delivery, with exceptional attention to the finest details and the highest quality standards.
              </p>
            </div>
          </Reveal>
                    ...
                    <StaggerChild key={i}>
                      <div
                        className={`py-8 px-6 text-center ${
                          i % 2 === 0 ? "border-e border-gold/15" : ""
                        } ${i < 2 ? "border-b border-gold/15" : ""}`}
                      >
                        <div className="font-serif text-4xl lg:text-5xl text-gold mb-3 leading-none">
                          <Counter to={stat.val} suffix={stat.suffix} />
                        </div>
                        <div className="text-[11px] font-light tracking-widest text-cream/45 uppercase leading-tight">
                          <span className="ar block">{stat.label_ar}</span>
                          <span className="en block">{stat.label_en}</span>
                        </div>
                      </div>
                    </StaggerChild>
                  ))}
            ...
            <Reveal direction="left">
              ...
              <h2 className="font-serif text-4xl lg:text-5xl xl:text-6xl text-cream-light leading-[1.15]">
                <span className="ar">
                  من الفكرة
                  <br />
                  <em className="not-italic text-gold">إلى المخطط</em>
                </span>
                <span className="en">
                  From Concept
                  <br />
                  <em className="italic text-gold">to Blueprint</em>
                </span>
              </h2>
            </Reveal>
            ...
            {[
              ...
              <StaggerChild key={idx}>
                <div className="group relative bg-charcoal p-10 xl:p-12 h-full cursor-default overflow-hidden transition-colors duration-500 hover:bg-charcoal-light">
                  ...
                  <p className="text-sm font-light text-cream/35 leading-[1.9]">
      ...
      <section id="execution-services" className="py-32 lg:py-40 px-6 bg-cream-light relative overflow-hidden">
        ...
        <div className="absolute end-0 top-1/2 -translate-y-1/2 font-serif text-[200px] font-bold text-charcoal/3 leading-none pointer-events-none select-none hidden xl:block">
          KD
        </div>
        ...
        <div className="max-w-[1300px] mx-auto relative z-10">
          <Reveal>
            ...
            <h2 className="font-serif text-4xl lg:text-5xl xl:text-6xl text-charcoal leading-[1.15] mb-20">
              <span className="ar">
                من المخطط
                <br />
                <em className="not-italic text-gold-dark">إلى الواقع</em>
              </span>
              <span className="en">
                From Blueprint
                <br />
                <em className="italic text-gold-dark">To Reality</em>
              </span>
            </h2>
          </Reveal>
          ...
          <StaggerParent className="grid grid-cols-1 md:grid-cols-2 border border-charcoal/8">
            {[
              ...
              <StaggerChild key={idx}>
                <div
                  className={`group flex items-start gap-7 p-10 xl:p-12 transition-colors duration-400 hover:bg-cream-dark/40 border-b border-charcoal/8 ${
                    idx % 2 === 0 ? "md:border-e md:border-charcoal/8" : ""
                  }`}
                >
                  {/* icon box */}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="font-serif text-[11px] text-charcoal/20 tracking-widest">{item.num}</span>
                    </div>
              ...
              {[
                {
                  ...
                  valAr: "0555 558 998",
                  valEn: "0555 558 998",
                  link: "https://wa.me/96855558998",
                },
                {
                  icon: Instagram,
                  labelAr: "إنستغرام",
                  labelEn: "Instagram",
                  valAr: "@future_design_decore",
                  valEn: "@future_design_decore",
                  link: "https://instagram.com/future_design_decore",
                },
                {
                  icon: MapPin,
                  labelAr: "الموقع",
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-base font-medium text-cream/90">
      ...
      <footer className="bg-charcoal border-t border-gold/10 py-8 px-6">
        <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <a
              href="https://instagram.com/future_design_decore"
              target="_blank"
              rel="noopener noreferrer"
